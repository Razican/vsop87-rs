...
pub const L0: [(f64, f64, f64); 623] = [(1.75347045673, 0.00000000000, 0.00000000000),
...
pub const L1: [(f64, f64, f64); 379] = [(6283.07584999140, 0.00000000000, 0.00000000000),
...
pub const L2: [(f64, f64, f64); 144] = [(0.00008721859, 1.07253635559, 6283.07584999140),
                                        (0.00000990990, PI, 0.00000000000),
...
pub const L3: [(f64, f64, f64); 23] = [(0.00000289058, 5.84173149732, 6283.07584999140),
                                       (0.00000020712, 6.04983939020, 12566.15169998280),
                                       (0.00000002962, 5.19560579570, 155.42039943420),
                                       (0.00000002527, PI, 0.00000000000),
...
pub const L4: [(f64, f64, f64); 11] = [(0.00000007714, 4.14117321449, 6283.07584999140),
...
pub const L5: [(f64, f64, f64); 4] = [(0.00000000172, 2.74854172392, 6283.07584999140),
...
pub const B0: [(f64, f64, f64); 184] = [(0.00000279620, 3.19870156017, 84334.66158130829),
                                        ...
                                        (0.00000001039, PI, 0.00000000000),
...
pub const B1: [(f64, f64, f64); 134] = [(0.00227777722, 3.41376620530, 6283.07584999140),
...
pub const B2: [(f64, f64, f64); 62] = [(0.00009721424, 5.15192809920, 6283.07584999140),
                                       (0.00000233002, PI, 0.00000000000),
...
pub const B3: [(f64, f64, f64); 14] = [(0.00000275993, 0.59480097092, 6283.07584999140),
                                       (0.00000017034, PI, 0.00000000000),
...
pub const B4: [(f64, f64, f64); 6] = [(0.00000005745, 2.26734029843, 6283.07584999140),
...
pub const B5: [(f64, f64, f64); 2] = [(0.00000000114, 4.31455980099, 6283.07584999140),
                                      (0.00000000024, 0.00000000000, 0.00000000000)];

pub const R0: [(f64, f64, f64); 523] = [(1.00013988784, 0.00000000000, 0.00000000000),
...
pub const R1: [(f64, f64, f64); 290] = [(0.00103018607, 1.10748968172, 6283.07584999140),
                                        (0.00001721238, 1.06442300386, 12566.15169998280),
                                        (0.00000702217, PI, 0.00000000000),
...
pub const R2: [(f64, f64, f64); 134] = [(0.00004359385, 5.78455133808, 6283.07584999140),
                                        (0.00000123633, 5.57935427994, 12566.15169998280),
                                        (0.00000012342, PI, 0.00000000000),
...
pub const R3: [(f64, f64, f64); 20] = [(0.00000144595, 4.27319433901, 6283.07584999140),
...
pub const R4: [(f64, f64, f64); 9] = [(0.00000003858, 2.56389016346, 6283.07584999140),
