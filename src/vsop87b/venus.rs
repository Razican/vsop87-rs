...
pub const L0: [(f64, f64, f64); 416] = [(3.17614666774, 0.00000000000, 0.00000000000),
...
pub const L1: [(f64, f64, f64); 235] = [(10213.28554621638, 0.00000000000, 0.00000000000),
...
pub const L2: [(f64, f64, f64); 72] = [(0.00003894209, 0.34823650721, 10213.28554621100),
...
pub const L3: [(f64, f64, f64); 7] = [(0.00000136328, 4.79698723753, 10213.28554621100),
                                      (0.00000030661, 3.71663788064, 20426.57109242200),
                                      (0.00000003041, PI, 0.00000000000),
...
pub const L4: [(f64, f64, f64); 4] = [(0.00000001636, 2.50540811485, 10213.28554621100),
...
pub const L5: [(f64, f64, f64); 2] = [(0.00000000122, 1.88711724630, 10213.28554621100),
                                      (0.00000000043, 0.42125909290, 20426.57109242200)];

pub const B0: [(f64, f64, f64); 210] = [(0.05923638472, 0.26702775812, 10213.28554621100),
                                        (0.00040107978, 1.14737178112, 20426.57109242200),
                                        (0.00032814918, PI, 0.00000000000),
...
pub const B1: [(f64, f64, f64); 121] = [(0.00287821243, 1.88964962838, 10213.28554621100),
...
pub const B2: [(f64, f64, f64); 51] = [(0.00012657745, 3.34796457029, 10213.28554621100),
...
pub const B3: [(f64, f64, f64); 12] = [(0.00000376505, 4.87650249694, 10213.28554621100),
                                       (0.00000012587, PI, 0.00000000000),
...
pub const B4: [(f64, f64, f64); 4] = [(0.00000008558, 0.17181972054, 10213.28554621100),
                                      (0.00000000114, 2.50366130090, 20426.57109242200),
                                      (0.00000000115, PI, 0.00000000000),
                                      (0.00000000041, 0.74061432691, 30639.85663863300)];

pub const B5: [(f64, f64, f64); 4] = [(0.00000000149, 1.67437168506, 10213.28554621100),
...
pub const R0: [(f64, f64, f64); 323] = [(0.72334820891, 0.00000000000, 0.00000000000),
...
pub const R1: [(f64, f64, f64); 174] = [(0.00034551041, 0.89198706276, 10213.28554621100),
                                        (0.00000234203, 1.77224942363, 20426.57109242200),
                                        (0.00000233998, PI, 0.00000000000),
...
pub const R2: [(f64, f64, f64); 62] = [(0.00001406587, 5.06366395112, 10213.28554621100),
...
pub const R3: [(f64, f64, f64); 8] = [(0.00000049582, 3.22264415899, 10213.28554621100),
                                      (0.00000000831, 3.21255590531, 20426.57109242200),
                                      (0.00000000112, PI, 0.00000000000),
...
pub const R4: [(f64, f64, f64); 3] = [(0.00000000573, 0.92253525592, 10213.28554621100),
                                      (0.00000000039, 0.95696787303, 20426.57109242200),
                                      (0.00000000006, PI, 0.00000000000)];
