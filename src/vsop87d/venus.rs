...
pub const L0: [(f64, f64, f64); 367] = [(3.17614666774, 0.00000000000, 0.00000000000),
...
pub const L1: [(f64, f64, f64); 215] = [(10213.52943052898, 0.00000000000, 0.00000000000),
...
pub const L2: [(f64, f64, f64); 70] = [(0.00054127076, 0.00000000000, 0.00000000000),
...
pub const L3: [(f64, f64, f64); 9] = [(0.00000135742, 4.80389020993, 10213.28554621100),
...
pub const L4: [(f64, f64, f64); 5] = [(0.00000114016, PI, 0.00000000000),
...
pub const L5: [(f64, f64, f64); 5] = [(0.00000000874, PI, 0.00000000000),
...
pub const B0: [(f64, f64, f64); 210] = [(0.05923638472, 0.26702775813, 10213.28554621100),
...
pub const B1: [(f64, f64, f64); 133] = [(0.00513347602, 1.80364310797, 10213.28554621100),
...
pub const B2: [(f64, f64, f64); 59] = [(0.00022377665, 3.38509143877, 10213.28554621100),
...
pub const B3: [(f64, f64, f64); 15] = [(0.00000646671, 4.99166565277, 10213.28554621100),
                                       (0.00000019952, PI, 0.00000000000),
...
pub const B4: [(f64, f64, f64); 5] = [(0.00000014102, 0.31537190181, 10213.28554621100),
                                      (0.00000000190, 2.35466404492, 20426.57109242200),
                                      (0.00000000164, 0.74476215141, 30639.85663863300),
                                      (0.00000000214, PI, 0.00000000000),
                                      (0.00000000004, 2.34190883009, 40853.14218484400)];

pub const B5: [(f64, f64, f64); 4] = [(0.00000000239, 2.05201727566, 10213.28554621100),
...
pub const R0: [(f64, f64, f64); 330] = [(0.72334820905, 0.00000000000, 0.00000000000),
...
pub const R1: [(f64, f64, f64); 180] = [(0.00034551039, 0.89198710598, 10213.28554621100),
...
pub const R2: [(f64, f64, f64); 63] = [(0.00001406587, 5.06366395190, 10213.28554621100),
...
pub const R3: [(f64, f64, f64); 7] = [(0.00000049582, 3.22263554520, 10213.28554621100),
...
pub const R4: [(f64, f64, f64); 3] = [(0.00000000573, 0.92229697820, 10213.28554621100),
