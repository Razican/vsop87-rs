...
pub const L0: [(f64, f64, f64); 760] = [(0.59954691495, 0.00000000000, 0.00000000000),
...
pub const L1: [(f64, f64, f64); 369] = [(529.93480757497, 0.00000000000, 0.00000000000),
...
pub const L2: [(f64, f64, f64); 191] = [(0.00047233598, 4.32148323554, 7.11354700080),
...
pub const L3: [(f64, f64, f64); 109] = [(0.00006501665, 2.59862880482, 7.11354700080),
...
pub const L4: [(f64, f64, f64); 45] = [(0.00000669483, 0.85282421090, 7.11354700080),
                                       (0.00000099961, 0.74258947751, 14.22709400160),
                                       (0.00000114019, PI, 0.00000000000),
...
pub const L5: [(f64, f64, f64); 10] = [(0.00000049577, 5.25658966184, 7.11354700080),
                                       ...
                                       (0.00000000845, PI, 0.00000000000),
...
pub const B0: [(f64, f64, f64); 249] = [(0.02268615703, 3.55852606718, 529.69096509460),
...
pub const B1: [(f64, f64, f64); 141] = [(0.00177351787, 5.70166488486, 529.69096509460),
                                        ...
                                        (0.00001694232, PI, 0.00000000000),
...
pub const B2: [(f64, f64, f64); 81] = [(0.00008094051, 1.46322843658, 529.69096509460),
                                       (0.00000742415, 0.95691639003, 522.57741809380),
                                       (0.00000813244, PI, 0.00000000000),
...
pub const B3: [(f64, f64, f64); 42] = [(0.00000251624, 3.38087923084, 529.69096509460),
                                       ...
                                       (0.00000002798, PI, 0.00000000000),
...
pub const B4: [(f64, f64, f64); 12] = [(0.00000015050, 4.52956999637, 522.57741809380),
...
pub const B5: [(f64, f64, f64); 5] = [(0.00000001445, 0.09198554072, 522.57741809380),
...
pub const R0: [(f64, f64, f64); 745] = [(5.20887429471, 0.00000000000, 0.00000000000),
...
pub const R1: [(f64, f64, f64); 381] = [(0.01271801596, 2.64937511122, 529.69096509460),
...
pub const R2: [(f64, f64, f64); 190] = [(0.00079644833, 1.35865896596, 529.69096509460),
                                        ...
                                        (0.00000497920, PI, 0.00000000000),
...
pub const R3: [(f64, f64, f64); 98] = [(0.00003519257, 6.05800633846, 529.69096509460),
                                       ...
                                       (0.00000089729, PI, 0.00000000000),
...
pub const R4: [(f64, f64, f64); 46] = [(0.00000128628, 0.08419309557, 536.80451209540),
                                       ...
                                       (0.00000001697, 0.00000000000, 0.00000000000),
