...
#[test]
fn it_mercury() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = mercury(2451545.0);
    ...
    assert!(p > 0.0456355030 && p < 0.0456355032);
    ...
    assert!(p > 0.0458905454 && p < 0.0458905456);
    ...
    assert!(p > 0.0460171831 && p < 0.0460171833);
    ...
    assert!(p > 0.0461440821 && p < 0.0461440823);
    ...
    assert!(p > 0.0462713709 && p < 0.0462713711);
    ...
    assert!(p > 0.0463978781 && p < 0.0463978783);
    ...
    assert!(p > 0.0465244775 && p < 0.0465244777);
    ...
    assert!(p > 0.0466514561 && p < 0.0466514563);
    ...
    assert!(p > 0.0467766327 && p < 0.0467766329);
}

#[test]
fn it_venus() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = venus(2451545.0);
    ...
    assert!(p > 0.0288637006 && p < 0.0288637008);
    ...
    assert!(p > 0.0289015622 && p < 0.0289015624);
    ...
    assert!(p > 0.0289381364 && p < 0.0289381366);
    ...
    assert!(p > 0.0289747588 && p < 0.0289747590);
    ...
    assert!(p > 0.0290086793 && p < 0.0290086795);
    ...
    assert!(p > 0.0290424555 && p < 0.0290424557);
    ...
    assert!(p > 0.0290755721 && p < 0.0290755723);
    ...
    assert!(p > 0.0291056457 && p < 0.0291056459);
    ...
    assert!(p > 0.0291355397 && p < 0.0291355399);
}

#[test]
fn it_mars() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = mars(2451545.0);
    ...
    assert!(p > 0.0122862592 && p < 0.0122862594);
    ...
    assert!(p > 0.0123926640 && p < 0.0123926642);
    ...
    assert!(p > 0.0124994657 && p < 0.0124994659);
    ...
    assert!(p > 0.0126070948 && p < 0.0126070950);
    ...
    assert!(p > 0.0127126596 && p < 0.0127126598);
    ...
    assert!(p > 0.0128192549 && p < 0.0128192551);
    ...
    assert!(p > 0.0129255290 && p < 0.0129255292);
    ...
    assert!(p > 0.0130315955 && p < 0.0130315957);
    ...
    assert!(p > 0.0132404724 && p < 0.0132404726);
}

#[test]
fn it_jupiter() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = jupiter(2451545.0);
    ...
    assert!(p > 0.0111943278 && p < 0.0111943280);
    ...
    assert!(p > 0.0112155193 && p < 0.0112155195);
    ...
    assert!(p > 0.0112561274 && p < 0.0112561276);
    ...
    assert!(p > 0.0112774526 && p < 0.0112774528);
    ...
    assert!(p > 0.0112976156 && p < 0.0112976158);
    ...
    assert!(p > 0.0113231800 && p < 0.0113231802);
    ...
    assert!(p > 0.0113590527 && p < 0.0113590529);
    ...
    assert!(p > 0.0113914437 && p < 0.0113914439);
    ...
    assert!(p > 0.0114181036 && p < 0.0114181038);
}

#[test]
fn it_saturn() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = saturn(2451545.0);
    ...
    assert!(p > 0.0198660070 && p < 0.0198660072);
    ...
    assert!(p > 0.0198069222 && p < 0.0198069224);
    ...
    assert!(p > 0.0197544699 && p < 0.0197544701);
    ...
    assert!(p > 0.0197022159 && p < 0.0197022161);
    ...
    assert!(p > 0.0196118552 && p < 0.0196118554);
    ...
    assert!(p > 0.0195453357 && p < 0.0195453359);
    ...
    assert!(p > 0.0194511459 && p < 0.0194511461);
    ...
    assert!(p > 0.0193699267 && p < 0.0193699269);
    ...
    assert!(p > 0.0193059635 && p < 0.0193059637);
}

#[test]
fn it_uranus() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = uranus(2451545.0);
    ...
    assert!(p > 0.0064803903 && p < 0.0064803905);
    ...
    assert!(p > 0.0065066743 && p < 0.0065066745);
    ...
    assert!(p > 0.0065218892 && p < 0.0065218894);
    ...
    assert!(p > 0.0065105136 && p < 0.0065105138);
    ...
    assert!(p > 0.0065416747 && p < 0.0065416749);
    ...
    assert!(p > 0.0065483500 && p < 0.0065483502);
    ...
    assert!(p > 0.0065585667 && p < 0.0065585669);
    ...
    assert!(p > 0.0065837505 && p < 0.0065837507);
    ...
    assert!(p > 0.0065887391 && p < 0.0065887393);
    ...
    assert!(p > 0.0066094090 && p < 0.0066094092);
}

#[test]
fn it_neptune() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = neptune(2451545.0);
    ...
    assert!(p > 0.0115021343 && p < 0.0115021345);
    ...
    assert!(p > 0.0115006029 && p < 0.0115006031);
    ...
    assert!(p > 0.0115084037 && p < 0.0115084039);
    ...
    assert!(p > 0.0115104795 && p < 0.0115104797);
    ...
    assert!(p > 0.0114974059 && p < 0.0114974061);
    ...
    assert!(p > 0.0114811412 && p < 0.0114811414);
    ...
    assert!(p > 0.0114767568 && p < 0.0114767570);
    ...
    assert!(p > 0.0114835737 && p < 0.0114835739);
    ...
    assert!(p > 0.0114950235 && p < 0.0114950237);
    ...
    assert!(p > 0.0114907691 && p < 0.0114907693);
}

#[test]
fn it_earth_moon() {
    let (mut a, mut l, mut k, mut h, mut q, mut p) = earth_moon(2451545.0);
    ...
    assert!(p > 0.0000006283 && p < 0.0000006285);
    ...
    assert!(p > -0.0000102594 && p < -0.0000102592);
    ...
    assert!(p > -0.0000189450 && p < -0.0000189448);
    ...
    assert!(p > -0.0000264087 && p < -0.0000264085);
    ...
    assert!(p > -0.0000336828 && p < -0.0000336826);
    ...
    assert!(p > -0.0000388821 && p < -0.0000388819);
    ...
    assert!(p > -0.0000438365 && p < -0.0000438363);
    ...
    assert!(p > -0.0000484643 && p < -0.0000484641);
    ...
    assert!(p > -0.0000505302 && p < -0.0000505300);
